...
window.onload = function(){
      var imageContainer = document.querySelector("#Myimg");
    
     var myImageStr="<br/>";
     
        for(var i=0; i < images.length; i++){ 
          //  myImageStr[i]  = "bb";     
       myImageStr += "<img  alt='" + images[i].alt + "' src='" + images[i].url + "'/><figcaption align='left'>" + images[i].caption +"</figcaption><br/><br/>";
        //k++;     
